...
const blogContent ={
    ...
    
    {
        ...
        title: "The Ultimate Guide to Choosing the Right Life Insurance for Your Family",
        excerpt: "Learn the best practices and simple steps to safeguard your home and loved ones from potential break-ins and theft.",
        author: {
    ...
    <section className='py-20 bg-light overflow-x-hidden'>
        <div className='container px-4 mx-auto'>
            <div className='lg:flex justify-between items-center mb-10'>
                ...
                {blogContent.heading.headingSubTitle}</span> 
                )}
                ...
                <div className='lg:w-5/12 text-left lg:text-right'>
                    <div className='inline-flex ml-auto space-x-3'>
                        ...
                        <div onClick={nextHandler} className={`${ isBeginning == true ? "opacity-30 bg-[#E1E7EA] cursor-auto" : "opacity-100 hover:bg-primary"} group transition-all duration-300 ease-in-out w-12 h-12 cursor-pointer bg-[#E1E7EA] rounded-full inline-flex justify-center items-center`}>
                        ...
                        <div onClick={prevHandler} className={`${ isEnd == true ? "opacity-30 bg-[#E1E7EA] cursor-auto" : "opacity-100 hover:bg-primary"} group transition-all duration-300 ease-in-out w-12 h-12 cursor-pointer bg-[#E1E7EA] rounded-full inline-flex justify-center items-center`}>
                    ...
                    <SwiperSlide className="overflow-visible h-full" key={blogContent} blogContent={blogContent}>
                        ...
                        <div className='p-5 rounded-lg bg-white relative mt-10'>
                            <Link href={blog.permalink} className='relative -mt-10 inline-block overflow-hidden rounded-lg mb-4'>
                                <Image src={blog.featuredImg} width={782} height={467} alt='hey' />
                            </Link>
                            ...
                            <div className='flex items-center space-x-4'>
                                <div className='flex-shrink-0'>
                                    <Image src={blog.author.img} width={50} height={50} alt='bro' className='rounded-full object-cover w-14 h-14' />
                                </div>
            ...
            <div className='mx-auto flex items-center justify-center'>
                <Link href={blogContent.cta.href} className='duration-300 transition-all ease-in-out py-3 px-6 flex border rounded-full space-x-3 items-center hover:border-gray-400'>
